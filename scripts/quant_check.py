...
def main():
    targets = [
        ("214430", "아이쓰리시스템(주전)"), ("445090", "에이직랜드(주전)"), ("389650", "넥스트바이오메디컬(주전)"),
        ("253590", "네오셈"), ("121600", "나노신소재"), ("094360", "칩스앤미디어"), ("039200", "오스코텍"),
        ("083650", "비에이치아이"), ("397030", "에이프릴바이오"), ("372320", "큐로셀"), ("456010", "아이씨티케이"),
    ]
